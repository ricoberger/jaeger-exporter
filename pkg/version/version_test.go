...
func TestPrint(t *testing.T) {
	...
	version, err := Print("jaeger-exporter")
	require.NoError(t, err)
	require.Equal(t, fmt.Sprintf("jaeger-exporter, version v0.7.0-29-gcc373f2 (branch: main, revision: cc373f263575773f1349bbd354e803cc85f9edcd)\n  build user:       root\n  build date:       2021-12-23@09:46:17\n  go version:       %s", goVersion), version)
}
